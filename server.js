...
client.on("guildMemberAdd", async member => {
  ...
  .setBackground(WelImg || "https://i.pinimg.com/originals/33/19/45/33194553f3b5a2f3dd2902ffa627c6fa.gif")
  .toAttachment();
...
client.on("guildMemberRemove", async member => {
  ...
  .setAvatar(member.user.displayAvatarURL({ dynamic: false, format: "jpg" }))
  .setMemberCount(member.guild.memberCount)
  .setBackground(LeaveImg || "https://i.pinimg.com/originals/33/19/45/33194553f3b5a2f3dd2902ffa627c6fa.gif")
  .toAttachment();
